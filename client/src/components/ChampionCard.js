...
function ChampionCard({ champion, handleAddComment, handleDeleteComment, handleCommentUpdate }) {
    ...
    return (
        <div>
            ...
            <NewComment champion={champion} handleAddComment={handleAddComment} handleDeleteComment={handleDeleteComment} handleCommentUpdate={handleCommentUpdate}/>
        </div>
    )
}
