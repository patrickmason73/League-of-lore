    ...
    return (
        <div style={{ backgroundImage: "linear-gradient(to right, #fc5c7d, #6a82fb)", width: "100%", paddingTop: "10px", height: "100%"}}>
            ...
            <span style={{marginRight: "auto", marginLeft: "80px", width: "600px"}}>
                 ...
                 <div style={{ marginTop: "10px", borderStyle: "groove", borderColor: "black", borderRadius: "5px", borderWidth: "5px", textAlign: "center"}}><p style={{marginBottom: "0px", fontWeight: "800", fontSize: "175%", textDecorationLine: "underline", marginLeft: "14px", marginTop: "0"}}>Your Posts:</p><br/>{displayPosts}</div>
            </span>
            ...
            <span style={{marginLeft: "auto", marginRight: "80px", width: "600px"}}>
                ...
                <div style={{marginRight: "80px", marginLeft: "auto", textAlign: "center", borderStyle: "groove", borderColor: "black", borderWidth: "5px", marginTop: "40px"}}><b style={{textDecoration: "underline", paddingTop: "40px", marginTop: "100px", fontWeight: "800", fontSize: "120%" }}>Champions You Commented On:</b> <br/> {displayChamps} </div>
            </span>
            </span>
